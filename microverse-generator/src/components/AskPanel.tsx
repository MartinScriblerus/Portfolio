...
export default function AskPanel() {
  ...
  return (
    <div style={{ position: 'absolute', top: 16, right: 16, width: 380, padding: '12px 14px', background: 'rgba(0,0,0,0.45)', color: '#e9f1ff', fontFamily: 'system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif', border: '1px solid rgba(255,255,255,0.15)', borderRadius: 8, zIndex: 10050 }}>
      <div>
