...
export function initializeUniversalSources(): Sources {
  const sources: Sources = {
    ...
    audioin: {
      ...
      detune: 0,
      effects: {
        WinFuncEnv: createEffectSettings('WinFuncEnv', stkVariableWinFuncEnv, winFuncEnvPresets, winFuncEnvDefault, 'audioin'),
        ExpEnv: createEffectSettings('ExpEnv', stkVariableExpEnv, expEnvPresets, expEnvDefault, 'audioin'),
        WPDiodeLadder: createEffectSettings('WPDiodeLadder', stkVariableWPDiodeLadder, wpDiodeLadderPresets, wpDiodeDefault, 'audioin'),
        WPKorg35: createEffectSettings('WPKorg35', stkVariableWPKorg35, wpKorg35Presets, korg35Default, 'audioin'),
        Modulate: createEffectSettings('Modulate', stkVariableModulate, modulatePresets, modulateDefault, 'audioin'),
        Delay: createEffectSettings('Delay', stkVariableDelay, delayPresets, delayDefault, 'audioin'),
        DelayA: createEffectSettings('DelayA', stkVariableDelayA, delayAPresets, delayADefault, 'audioin'),
        DelayL: createEffectSettings('DelayL', stkVariableDelayL, delayLPresets, delayLDefault, 'audioin'),
        Echo: createEffectSettings('Echo', stkVariableEcho, echoPresets, delayDefault, 'audioin'),
        ExpDelay: createEffectSettings('ExpDelay', stkVariableExpDelay, expDelayPresets, expDelayDefault, 'audioin'),
        Elliptic: createEffectSettings('Elliptic', stkVariableElliptic, ellipticPresets, ellipticDefault, 'audioin'),
        Spectacle: createEffectSettings('Spectacle', stkVariableSpectacle, spectaclePresets, spectacleDefault, 'audioin'),
        Gain: createEffectSettings('Gain', stkVariableGain, gainPresets, {}, 'audioin'),
        Bitcrusher: createEffectSettings('Bitcrusher', stkVariableBitcrusher, bitcrusherPresets, {}, 'audioin'),
        FoldbackSaturator: createEffectSettings('FoldbackSaturator', stkVariableFoldbackSaturator, foldbackSaturatorPresets, {}, 'audioin'),
        Chorus: createEffectSettings('Chorus', stkVariableChorus, chorusPresets, {}, 'audioin'),
        PitShift: createEffectSettings('PitShift', stkVariablePitShift, pitchShiftPresets, {}, 'audioin'),
        AmbPan3: createEffectSettings('AmbPan3', stkVariableAmbPan3, ambPan3Presets, {}, 'audioin'),
        JCRev: createEffectSettings('JCRev', stkVariableJCRev, jcRevPresets, {}, 'audioin'),
        NRev: createEffectSettings('NRev', stkVariableNRev, nRevPresets, {}, 'audioin'),
        PRCRev: createEffectSettings('PRCRev', stkVariablePRCRev, prcRevPresets, {}, 'audioin'),
        GVerb: createEffectSettings('GVerb', stkVariableGVerb, gVerbPresets, {}, 'audioin'),
        PowerADSR: createEffectSettings('PowerADSR', stkVariablePowerADSR, powerADSRPresets, powerADSRDefault, 'audioin'),
        KasFilter: createEffectSettings('KasFilter', stkVariableKasFilter, kasFilterPresets, {}, 'audioin'),
        Multicomb: createEffectSettings('Multicomb', stkVariableMulticomb, multicombPresets, {}, 'audioin'),
        PitchTrack: createEffectSettings('PitchTrack', stkVariablePitchTrack, pitchTrackPresets, {}, 'audioin'),
        Sigmund: createEffectSettings('Sigmund', stkVariableSigmund, sigmundPresets, {}, 'audioin'),
        SndBuf: createEffectSettings('SndBuf', stkVariableSndBuf, sndBufPresets, {}, 'audioin'),
        LiSa: createEffectSettings('LiSa', stkVariableLisa, lisaPresets, {}, 'audioin'),
      },
      effectsString: '',
      pattern: [],
      arpeggiateOn: false,
